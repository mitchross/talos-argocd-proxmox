...
| **Managed namespaces** (`pvc-plumber.io/managed-namespace=true`; RBAC via cluster-wide CRB) | `nginx-example`, `homepage-dashboard`, `karakeep`, `fizzy`, `frigate`, `project-nomad`, `tubesync`, `copyparty`, `jellyfin`, `open-webui`, `perplexica`, `project-zomboid`, `swarmui` (13) |
