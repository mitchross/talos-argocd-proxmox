...
echo "   Wave 4: Infrastructure AppSet + database support; CNPG clusters wait for the recovery script"
echo "   Wave 5: OTEL Operator + Monitoring AppSet (Prometheus, Grafana, Loki)"
echo "   Wave 6: Observability + user workloads; CNPG consumers wait for their restored databases"
echo ""
echo "🔍 Monitor progress with:"
echo "   kubectl get applications -n argocd -w"
echo ""
echo "🛟 Complete the prepared CNPG recovery after Waves 0-4 are healthy:"
echo "   ./scripts/bootstrap-cnpg-recovery.sh --execute"
echo ""
