...
echo "   Wave 3: kopiur config (ClusterRepository, cred fanout, snapclass)"
echo "   Wave 4: Infrastructure AppSet + Database AppSet (plain Postgres restores via kopiur)"
echo "   Wave 5: OTEL Operator + Monitoring AppSet (Prometheus, Grafana, Loki)"
echo "   Wave 6: Observability + user workloads (backed-up PVCs hydrate via restore-before-bind)"
echo ""
...
echo "   Existing installations retain their configured login; see README.md for access."
echo ""
