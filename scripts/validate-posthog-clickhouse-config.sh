...
CONFIG_FILE="manifests/apps/development/posthog/base/config/clickhouse/config.d/default.xml"
DEPLOYMENT_FILE="manifests/apps/development/posthog/base/data-layer/clickhouse.yaml"
